  ...
  return (
    <div className="bg-black text-white py-16 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <button onClick={handleNextStep} className="mt-6 flex items-center gap-2 bg-[#4c00ff] hover:bg-purple-700 text-white px-6 py-3 -skew-x-12   font-medium transition-all">
        Next Step → 
        </button>
      </div>
    </div>
